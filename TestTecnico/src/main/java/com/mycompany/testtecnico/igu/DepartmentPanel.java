...
public class DepartmentPanel extends javax.swing.JFrame {
   ...
   private PersistenceController persisController;
    ...
    public DepartmentPanel() {
        ...
        iguCommodities.departmentList(list);
    ...
    private void initComponents() {
        ...
        jLabel18.setText("Deptos actuales:");
        ...
        jLabel6.setText("Agregar nuevo Departamento");
    ...
    private void listMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listMouseClicked
        if (evt.getClickCount() == 2) { // Doble clic
                    ...
                    Object department = list.getSelectedValue();
                    
                    persisController = new PersistenceController();
                    DepartmentEdit screen = new DepartmentEdit(persisController.findDepartment(department));
